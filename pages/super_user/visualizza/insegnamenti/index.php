...
<body>
    <?php
        ...
        titleImg ("../../../../");
    ?>
    <script src="scritpts/script.js?0.223"></script>
    <input type='hidden' id='anno' value='<?php echo $idanno; ?>' />
    <div class="container">
        <div class="row">
            <div class="col col-sm-12">
                <div class="panel">
                    ...
                    <div class="row">
                        ...
                        <div class="col col-sm-4">
                            Scuole
                            <select onchange="updateDocs($(this).val())" id='schools' class="form-control">
                                <?php
                                    $query = "SELECT * FROM scuola ORDER BY nome ASC";
                                    ...
                                    if (is_object($result) && $result->num_rows > 0)
                                    {
                                        while ($row = $result->fetch_assoc())
                                        {
                                            ...
                                            $nome_scuola = $row['nome'];
                                            
                                            echo "<option value='$id_scuola'>$nome_scuola</option>";
                                        }                                        
                                    }
                                ?>
                            </select>
                    ...
                    <table id="schoolDocs" class="table table-bordered">
                        <thead>
                        <th>
                            Classe
                        </th>
