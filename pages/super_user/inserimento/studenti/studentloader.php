...
<body>
                                        ...
                                        if (isset($nome) && !empty($nome) && isset($cognome) && !empty($cognome))
                                        {
                                            ...
                                            if ($result)
                                            {
                                                $insertquery = "INSERT INTO studente (id_studente, nome, cognome, citta, email, telefono, scuola_id_scuola)"
                                                            . " VALUES ((SELECT MAX(id_utente) FROM utente WHERE tipo_utente = ".studType."), '".$conn->escape_string($nome)."','".$conn->escape_string($cognome)."',".$cittaforinsert.",".$emailforinsert.",".$telefonoforinsert.", $scuola)";
    ...
    <script>
        ...
        var nome_scuola = localStorage.getItem("nome_scuola");
        
        doc.save(nome_scuola+"_"+nome_classe+"_"+nome_anno+"_Credenziali_Studenti.pdf");
        $("#forpdf").hide();
    </script>    
</body>      
    <?php
