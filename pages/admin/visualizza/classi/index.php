                ...
                <div class="panel" style="min-height: 0px">
                    ...
                    <?php
                        ...
                        if ($result = $connessione->query ($Query))
                        {
                            ...
                            $I=0;
                            echo "<div class=\"table-responsive\"><table class=\"table table-bordered\"> <thead style=\"background : #eee; font-color : white \"> <th style=\"text-align : center\"> Nome della classe </th> <th style=\"text-align : center\"> Azioni </th></thead> <tbody>";
