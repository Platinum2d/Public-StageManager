<?php
    ...
    $Query = "UPDATE  `azienda` SET  `username` =  '$username', ";
    if ($password !== "immutato") $Query .= "`password` =  '".md5($password)."', ";
    
    $Query .= " `nome_aziendale` =  '$nomeazienda', `citta_aziendale` =  '$cittaazienda', `CAP` =  '$capazienda', `indirizzo` =  '$indirizzoazienda', `telefono_aziendale` =  '$telefonoazienda',"
