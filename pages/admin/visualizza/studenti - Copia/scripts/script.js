...
<div class=\"col col-sm-6\"> \n\
                username <input class=\"form-control\" name=\"nc\" type=\"text\" id=\"username"+numberId+"\">\n\
                nome <input class=\"form-control\" type=\"text\" id=\"nome"+numberId+"\"> \n\
                cognome <input class=\"form-control\" type=\"text\" id=\"cognome"+numberId+"\">\n\
                citta <input class=\"form-control\" type=\"text\" id=\"citta"+numberId+"\">\n\
                e-mail <input class=\"form-control\" type=\"text\" id=\"email"+numberId+"\"> \n\
                telefono <input class=\"form-control\" type=\"number\" id=\"telefono"+numberId+"\">\n\
                inizio stage <input data-provide=\"datepicker\" class=\"form-control\" type=\"text\" id=\"iniziostage"+numberId+"\">\n\
                durata stage <input class=\"form-control\" type=\"number\" min=\"1\" id=\"duratastage"+numberId+"\">\n\
...
<div class=\"col col-sm-6\">\n\
                classe <select class=\"form-control\" id=\"classe"+numberId+"\"> </select>\n\
                ...
                <br>azienda <select class=\"form-control\" id=\"azienda"+numberId+"\"> </select>\n\
    ...
    if (!studente.username.isEmpty() && !studente.nome.isEmpty() && !studente.cognome.isEmpty() && !studente.citta.isEmpty() && !studente.mail.isEmpty())
    {
        ...
        $.ajax({
            ...
            {      
                ...
                $("#label"+numberId).html(cognome + " " + nome + " ("+username+")");
...
{
    var confirmed = confirm("Confermare la cancellazione di questo studente?");
    if (confirmed)
    {
        $.ajax({
            type : 'POST',
