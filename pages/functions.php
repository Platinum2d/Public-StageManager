...
HTML;
            ...
            if ($_SESSION ['type'] == superUserType) { // se e' loggato amministratore
                ...
                echo "<li class=\"dropdown dropdown-hover\">
                          <a href=\"".$goBack."pages/docente_referente/gestione-studenti/index.php\" class=\"dropdown-toggle disabled\" data-toggle=\"dropdown\" role=\"button\" aria-expanded=\"false\">Gestione studenti <span class=\"caret\"></span></a>
...
HTML;
                ...
                echo "<li><a href='".$goBack."pages/scuola/inserimento/moduli_valutazione/index.php'>Moduli di valutazione</a></li>";
                ...
                echo "<li><a href='".$goBack."pages/scuola/gestione/moduli_valutazione/index.php'>Moduli di valutazione</a></li>";
                echo "</ul></li>";
...
HTML;
    ...
    function import($goBack) { //importa librerie
        ...
        echo "<script src=\"".$goBack."pages/scripts.js?12\"> </script>";
...
<script>
    ...
    function generateRandomString($length = 32) {
        $characters = '12345678abcdefhijkmnpqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ';
