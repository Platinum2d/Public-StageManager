...
//         printBadge($goBack);
        ...
        echo "<div class='container'><div id='logo-row' class='row parent-max-height'><div class='col col-xs-4 col-sm-3'><a href='".$goBack."' title='Stage Manager'><img class='logo img-responsive' src='".$goBack."src/img/logo_stage_manager.png' alt='Stage Manager'></a></div>";
