...
function editModuleRow(id_riga)
{
    ...
    $.ajax({
        type : 'POST',
        url : 'ajaxOpsPerVisualizzaModuloStage/ajaxEditRow.php',
        cache : false,
        data : tosend,
...
function showOptionsTable(idcolonna)
{
    ...
    $.ajax({
        type : 'POST',
        url : 'ajaxOpsPerVisualizzaModuloStage/ajaxOpzioni.php',
        cache : false,
...
function deleteOption(id_opzione)
{
    $.ajax({
        type : 'POST',
        url : 'ajaxOpsPerVisualizzaModuloStage/ajaxDeleteOption.php',
        cache : false,
...
function deleteModuleColumn(id_colonna)
{
    $.ajax({
        type : 'POST',
        url : 'ajaxOpsPerVisualizzaModuloStage/ajaxDeleteColumn.php',
        cache : false,
...
function editColumn(idcolonna)
{
    ...
    $.ajax({
        type : 'POST',
        url : 'ajaxOpsPerVisualizzaModuloStage/ajaxEditColumn.php',
        cache : false,
        data : 
                {
                    'id' : idcolonna,
    ...
    $("#opTable").find("tr").each(function (){
        if (typeof($(this).attr("data-id")) !== "undefined")
        {
            $.ajax({
                async : false,
                type : 'POST',
                url : 'ajaxOpsPerVisualizzaModuloStage/ajaxEditOption.php',
                data : 
                        {
        ...
        else
        {
            if (typeof($(this).attr("data-new")) !== "undefined")
            {
                $.ajax({
                    async : false,
                    type : 'POST',
                    url : 'ajaxOpsPerVisualizzaModuloStage/ajaxAddOption.php',
                    data : 
                            {
                                'posizione' : $(this).find("td[data-role='optposition']").text(),
                        'opzione' : $(this).find("td[data-role='description']").text().trim(),
...
function addColumn(id_modulo)
{
    ...
    $.ajax({
        type : 'POST',
        url : 'ajaxOpsPerVisualizzaModuloStage/ajaxAddColumn.php',
        cache : false,
        data : tosend,
        success : function (msg)
        {
...
function addRow(id_modulo)
{
    ...
    $.ajax({
        type : 'POST',
        url : 'ajaxOpsPerVisualizzaModuloStage/ajaxAddRow.php',
        cache : false,
        data : tosend,
        success : function (msg)
        {
...
function deleteModuleRow(id_riga)
{
    $.ajax({
        type : 'POST',
        url : 'ajaxOpsPerVisualizzaModuloStage/ajaxDeleteRow.php',
        cache : false,
        data : { 'riga' : id_riga },
        success : function (msg)
        {
