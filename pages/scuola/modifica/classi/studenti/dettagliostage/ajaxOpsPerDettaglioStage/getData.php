...
$xml = new SimpleXMLElement ( $xmlstr );
    ...
    $query_general = "SELECT autorizzazione_registro FROM studente_has_stage WHERE studente_id_studente = $studente AND classe_has_stage_id_classe_has_stage = $classe_has_stage_id;";    
