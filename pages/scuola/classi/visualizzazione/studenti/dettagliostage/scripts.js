                 ...
                 <div class=\"col col-sm-12\"> \n\
                    <div class=\"row\"> \n\
                       <div class=\"col col-sm-6\"> \n\
                             ...
                             <label class='margin_bottom_label'>Docente</label><select class=\"form-control margin_bottom_input\" id=\"editinfodocente"+progressiv+"\"><option value=\"-1\"> </option> </select>\n\
                       </div> <br>\n\
                       <div class=\"col col-sm-6\"> \n\
